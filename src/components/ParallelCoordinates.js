...
class ParallelCoordinates extends Component {
  ...
  isOverLine(startPt, endPt, testPt, tol) {
    // from http://bl.ocks.org/mostaphaRoudsari/b4e090bb50146d88aec4
  ...
  render() {
    ...
    return <div ref="parcoords" className="parcoords" style={style} />;
  }
}
